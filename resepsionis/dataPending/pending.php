<?php 
    ...
    $queryPending = "SELECT * FROM pemesanan WHERE status_kamar = '$pending'";
        ...
        if($countPending > 0){
            while($dataHotel = mysqli_fetch_array($resultPending, MYSQLI_NUM)){
                ...
                <tr>
                    ...
                    <td>
                        <a href="acc.php?id_pesanan=<?php echo"$dataHotel[0]"?>">ACC</a> |
                        <a href="reject.php?id_pesanan=<?php echo"$dataHotel[0]"?>">Reject</a>
                    </td>
                <tr>
                </tr>
